...
Dim CTRLS_TO_POLL$(2) = ("snes_a", "atari_a", "keys_cursor_ext")
...
gamemite.set_title("Pico-Frog", "Martin Herhaus", VERSION)
 FRAMEBUFFER CREATE
...
'  Do While Inkey$<>"":Loop
  ...
  If CTRLS_TO_POLL$(0) <> "snes_a" Then start_key$ = "      Press Space       "
