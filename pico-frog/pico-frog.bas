...
'  Do While Inkey$<>"":Loop
  ...
  tc%=0: tk%=7
  controller_$ = ""
  Do While controller_$ = ""
    controller_$ = ctrl.poll_multiple$(CTRLS_TO_POLL$(), ctrl.A Or ctrl.B Or ctrl.START, 15)
    If TK%=7 Then
...
Sub on_break
 ...
 FRAMEBUFFER CLOSE
 ctrl.term_keys()
 If controller_$ <> "" Then Call controller_$, ctrl.CLOSE
 CLS
 Option Break 3
 End
End Sub
