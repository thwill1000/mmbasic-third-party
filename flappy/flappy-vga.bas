  ...
  'game defines
  Dim gap=90        'between columns
  Dim xb=100        'bird start position (constant)
  ...
  Open PATH$ + "high-score.txt" For input As #1
...
new_game:
  ...
  Do While Not get_input%() : Pause 5 : Loop
  CLS
...
Sub savescore
  'save new scores
  Open "high-score.txt" For output As #1
